...
project maintained by Ethosure Governance Inc. We welcome improvements to
...
For Ethosure Governance Inc. maintainers, `@paudley` and `@ErinAudley` are
directors of Ethosure Governance Inc. and are authorized to submit project
contributions on behalf of the company. The repository `CODEOWNERS` file lists
both maintainers as project owners.

## Governance and Continuity

`coding-ethos` is maintained by Ethosure Governance Inc. The project owners
...
Both project owners are directors of Ethosure Governance Inc. and have
...
For public questions, open an issue or discussion in the repository. For private matters, email <oss@ethosure.com>.
