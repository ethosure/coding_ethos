...
import (
	...
	"github.com/ethosure/coding_ethos/go/internal/e2e"
...
func managedGitCommitRepoConfig() string {
	return strings.Join([]string{
		...
		"    copyright: 2026 Ethosure Governance Inc. <oss@ethosure.com>",
		"    text: |",
...
func managedGitFixtureLicense() string {
	return strings.Join([]string{
		"Coding Ethos reference repository license.",
		"",
		"Copyright (c) 2026 Ethosure Governance Inc. <oss@ethosure.com>",
		"",
	}, "\n")
}
