...
func TestToolOutputCompressionGoldenToolOutputs(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			lines: append(
				append(
					[]string{"ok  github.com/ethosure/coding_ethos/go/internal/a  0.001s"},
					repeatedLines("ok  github.com/ethosure/coding_ethos/go/internal/noise  0.001s", 32)...,
				),
